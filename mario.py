...
class Flames:
    ...
    def __init__(self):
        self.flames = pygame.image.load('flame.png')
...
class Mario:
    ...
    def __init__(self):
        self.mario_img = pygame.image.load('player.png')
...
def game_over():
    ...
    music = pygame.mixer.Sound('mario_dies.ogg')
    music.play()
...
def game_loop():
    while True:
        ...
        pygame.mixer.music.load('mario_theme.ogg')
